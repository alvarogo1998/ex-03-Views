...
class ApiBurgerRemoteSource {
    ...
    companion object{
        val foodList: List<Food> = listOf(
            ...
            Food(
                2,
                "https://www.justspices.es/media/opti_image/webp/recipe/resized/510x510/recipe/Sazonador-Carne-Heinz-Bacon-Burger-Smash-burger_6_2.webp",
                "98 %",
                "20-30 min",
                "15 %",
            )
